...
Magadheera = media.Movie("Magadheera",  # assign movie name
                         "Past life",  # assign storyline
                         magadhera,  # assign image and trailer link
...
# list that includes the movie instances
